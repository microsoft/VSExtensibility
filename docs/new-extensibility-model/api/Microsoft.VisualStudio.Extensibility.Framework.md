...
- [ExtensionContext](#T-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext 'Microsoft.Internal.VisualStudio.Extensibility.Framework.ExtensionContext')
  - [ServiceBroker](#P-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext-ServiceBroker 'Microsoft.Internal.VisualStudio.Extensibility.Framework.ExtensionContext.ServiceBroker')
  - [ServiceProvider](#P-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext-ServiceProvider 'Microsoft.Internal.VisualStudio.Extensibility.Framework.ExtensionContext.ServiceProvider')
  - [TraceSource](#P-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext-TraceSource 'Microsoft.Internal.VisualStudio.Extensibility.Framework.ExtensionContext.TraceSource')
  - [CreateAndSetInitialContext()](#M-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext-CreateAndSetInitialContext 'Microsoft.Internal.VisualStudio.Extensibility.Framework.ExtensionContext.CreateAndSetInitialContext')
  - [RestoreServiceScope(capturedScope)](#M-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext-RestoreServiceScope-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext-ServiceScope- 'Microsoft.Internal.VisualStudio.Extensibility.Framework.ExtensionContext.RestoreServiceScope(Microsoft.Internal.VisualStudio.Extensibility.Framework.ExtensionContext.ServiceScope)')
  - [VerifyIsPresent\`\`1(value)](#M-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext-VerifyIsPresent``1-``0- 'Microsoft.Internal.VisualStudio.Extensibility.Framework.ExtensionContext.VerifyIsPresent``1(``0)')
- [ExtensionCore](#T-Microsoft-VisualStudio-Extensibility-ExtensionCore 'Microsoft.VisualStudio.Extensibility.ExtensionCore')
  ...
  - [CreateExtensionDescriptor(serviceDescriptor)](#M-Microsoft-VisualStudio-Extensibility-ExtensionCore-CreateExtensionDescriptor-Microsoft-ServiceHub-Framework-ServiceRpcDescriptor- 'Microsoft.VisualStudio.Extensibility.ExtensionCore.CreateExtensionDescriptor(Microsoft.ServiceHub.Framework.ServiceRpcDescriptor)')
  ...
  - [GetServiceScopeForTargetObject(targetObject)](#M-Microsoft-VisualStudio-Extensibility-ExtensionCore-GetServiceScopeForTargetObject-System-Object- 'Microsoft.VisualStudio.Extensibility.ExtensionCore.GetServiceScopeForTargetObject(System.Object)')
  ...
  - [ProfferBrokeredService(brokeredServiceConfiguration,descriptor)](#M-Microsoft-VisualStudio-Extensibility-ExtensionCore-ProfferBrokeredService-Microsoft-VisualStudio-Extensibility-BrokeredServiceConfiguration,Microsoft-ServiceHub-Framework-ServiceRpcDescriptor- 'Microsoft.VisualStudio.Extensibility.ExtensionCore.ProfferBrokeredService(Microsoft.VisualStudio.Extensibility.BrokeredServiceConfiguration,Microsoft.ServiceHub.Framework.ServiceRpcDescriptor)')
- [ExtensionMethods](#T-Microsoft-VisualStudio-Extensibility-Helpers-ExtensionMethods 'Microsoft.VisualStudio.Extensibility.Helpers.ExtensionMethods')
  ...
  - [ToServiceMoniker(brokeredServiceConfiguration)](#M-Microsoft-VisualStudio-Extensibility-Helpers-ExtensionMethods-ToServiceMoniker-Microsoft-VisualStudio-Extensibility-BrokeredServiceConfiguration- 'Microsoft.VisualStudio.Extensibility.Helpers.ExtensionMethods.ToServiceMoniker(Microsoft.VisualStudio.Extensibility.BrokeredServiceConfiguration)')
- [ExtensionPart](#T-Microsoft-VisualStudio-Extensibility-ExtensionPart 'Microsoft.VisualStudio.Extensibility.ExtensionPart')
  ...
  - [#ctor()](#M-Microsoft-VisualStudio-Extensibility-ExtensionPart-#ctor 'Microsoft.VisualStudio.Extensibility.ExtensionPart.#ctor')
...
- [ExtensionProvidedDescriptorFactory](#T-Microsoft-VisualStudio-Extensibility-ExtensionProvidedDescriptorFactory 'Microsoft.VisualStudio.Extensibility.ExtensionProvidedDescriptorFactory')
  - [CreateAsync()](#M-Microsoft-VisualStudio-Extensibility-ExtensionProvidedDescriptorFactory-CreateAsync-Microsoft-ServiceHub-Framework-ServiceMoniker,Microsoft-ServiceHub-Framework-ServiceActivationOptions,System-IServiceProvider,System-Type,System-Type- 'Microsoft.VisualStudio.Extensibility.ExtensionProvidedDescriptorFactory.CreateAsync(Microsoft.ServiceHub.Framework.ServiceMoniker,Microsoft.ServiceHub.Framework.ServiceActivationOptions,System.IServiceProvider,System.Type,System.Type)')
  - [GetServiceDescriptor()](#M-Microsoft-VisualStudio-Extensibility-ExtensionProvidedDescriptorFactory-GetServiceDescriptor-Microsoft-ServiceHub-Framework-ServiceMoniker- 'Microsoft.VisualStudio.Extensibility.ExtensionProvidedDescriptorFactory.GetServiceDescriptor(Microsoft.ServiceHub.Framework.ServiceMoniker)')
- [IAsyncCommand](#T-Microsoft-VisualStudio-Extensibility-UI-IAsyncCommand 'Microsoft.VisualStudio.Extensibility.UI.IAsyncCommand')
  ...
  - [ExecuteAsync(parameter,clientContext,cancellationToken)](#M-Microsoft-VisualStudio-Extensibility-UI-IAsyncCommand-ExecuteAsync-System-Object,Microsoft-VisualStudio-Extensibility-IClientContext,System-Threading-CancellationToken- 'Microsoft.VisualStudio.Extensibility.UI.IAsyncCommand.ExecuteAsync(System.Object,Microsoft.VisualStudio.Extensibility.IClientContext,System.Threading.CancellationToken)')
...
- [MessageContextJsonRpc](#T-Microsoft-VisualStudio-Extensibility-Framework-MessageContextJsonRpc 'Microsoft.VisualStudio.Extensibility.Framework.MessageContextJsonRpc')
  ...
  - [ServiceScope](#P-Microsoft-VisualStudio-Extensibility-Framework-MessageContextJsonRpc-ServiceScope 'Microsoft.VisualStudio.Extensibility.Framework.MessageContextJsonRpc.ServiceScope')
...
- [RemoteUserControl](#T-Microsoft-VisualStudio-Extensibility-UI-RemoteUserControl 'Microsoft.VisualStudio.Extensibility.UI.RemoteUserControl')
  - [#ctor(dataContext)](#M-Microsoft-VisualStudio-Extensibility-UI-RemoteUserControl-#ctor-System-Object- 'Microsoft.VisualStudio.Extensibility.UI.RemoteUserControl.#ctor(System.Object)')
  ...
  - [#ctor(dataContext,extensibility,synchronizationContext)](#M-Microsoft-VisualStudio-Extensibility-UI-RemoteUserControl-#ctor-System-Object,Microsoft-VisualStudio-Extensibility-VisualStudioExtensibility,System-Threading-SynchronizationContext- 'Microsoft.VisualStudio.Extensibility.UI.RemoteUserControl.#ctor(System.Object,Microsoft.VisualStudio.Extensibility.VisualStudioExtensibility,System.Threading.SynchronizationContext)')
  ...
  - [Microsoft#VisualStudio#RpcContracts#RemoteUI#IRemoteProxiedUserControl2#InvokeAsync()](#M-Microsoft-VisualStudio-Extensibility-UI-RemoteUserControl-Microsoft#VisualStudio#RpcContracts#RemoteUI#IRemoteProxiedUserControl2#InvokeAsync-Microsoft-VisualStudio-RpcContracts-RemoteUI-ObjectId,Microsoft-VisualStudio-RpcContracts-RemoteUI-MessagePackFragment,System-Collections-Generic-IReadOnlyDictionary{System-String,System-String},System-Threading-CancellationToken- 'Microsoft.VisualStudio.Extensibility.UI.RemoteUserControl.Microsoft#VisualStudio#RpcContracts#RemoteUI#IRemoteProxiedUserControl2#InvokeAsync(Microsoft.VisualStudio.RpcContracts.RemoteUI.ObjectId,Microsoft.VisualStudio.RpcContracts.RemoteUI.MessagePackFragment,System.Collections.Generic.IReadOnlyDictionary{System.String,System.String},System.Threading.CancellationToken)')
...
- [Resources](#T-Microsoft-VisualStudio-Extensibility-Framework-Resources 'Microsoft.VisualStudio.Extensibility.Framework.Resources')
  ...
  - [ServiceNotRegistered](#P-Microsoft-VisualStudio-Extensibility-Framework-Resources-ServiceNotRegistered 'Microsoft.VisualStudio.Extensibility.Framework.Resources.ServiceNotRegistered')
...
- [ServiceScope](#T-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext-ServiceScope 'Microsoft.Internal.VisualStudio.Extensibility.Framework.ExtensionContext.ServiceScope')
  - [ServiceBroker](#P-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext-ServiceScope-ServiceBroker 'Microsoft.Internal.VisualStudio.Extensibility.Framework.ExtensionContext.ServiceScope.ServiceBroker')
  - [ServiceProvider](#P-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext-ServiceScope-ServiceProvider 'Microsoft.Internal.VisualStudio.Extensibility.Framework.ExtensionContext.ServiceScope.ServiceProvider')
  - [TraceSource](#P-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext-ServiceScope-TraceSource 'Microsoft.Internal.VisualStudio.Extensibility.Framework.ExtensionContext.ServiceScope.TraceSource')
  - [InitializeScope(serviceProvider,serviceBroker,traceSource)](#M-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext-ServiceScope-InitializeScope-System-IServiceProvider,Microsoft-ServiceHub-Framework-IServiceBroker,System-Diagnostics-TraceSource- 'Microsoft.Internal.VisualStudio.Extensibility.Framework.ExtensionContext.ServiceScope.InitializeScope(System.IServiceProvider,Microsoft.ServiceHub.Framework.IServiceBroker,System.Diagnostics.TraceSource)')
...
This constructor is present for compatibility reasons, we recommend using the one with [IClientContext](#T-Microsoft-VisualStudio-Extensibility-IClientContext 'Microsoft.VisualStudio.Extensibility.IClientContext') in the callback signature.

<a name='M-Microsoft-VisualStudio-Extensibility-UI-AsyncCommand-#ctor-System-Func{System-Object,Microsoft-VisualStudio-Extensibility-IClientContext,System-Threading-CancellationToken,System-Threading-Tasks-Task}-'></a>
### #ctor(executeCallback) `constructor`
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| executeCallback | [System.Func{System.Object,Microsoft.VisualStudio.Extensibility.IClientContext,System.Threading.CancellationToken,System.Threading.Tasks.Task}](http://msdn.microsoft.com/query/dev14.query?appId=Dev14IDEF1&l=EN-US&k=k:System.Func 'System.Func{System.Object,Microsoft.VisualStudio.Extensibility.IClientContext,System.Threading.CancellationToken,System.Threading.Tasks.Task}') | The callback to be invoked when the command is executed. |
...
<a name='M-Microsoft-VisualStudio-Extensibility-UI-AsyncCommand-ExecuteAsync-System-Object,Microsoft-VisualStudio-Extensibility-IClientContext,System-Threading-CancellationToken-'></a>
### ExecuteAsync() `method`
...
<a name='M-Microsoft-VisualStudio-Extensibility-ClientContext-#ctor-System-Collections-Generic-IReadOnlyDictionary{System-String,System-String},Microsoft-VisualStudio-Extensibility-VisualStudioExtensibility-'></a>
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| contextProperties | [System.Collections.Generic.IReadOnlyDictionary{System.String,System.String}](http://msdn.microsoft.com/query/dev14.query?appId=Dev14IDEF1&l=EN-US&k=k:System.Collections.Generic.IReadOnlyDictionary 'System.Collections.Generic.IReadOnlyDictionary{System.String,System.String}') | Client context bag passed by remote commands provider. |
...
<a name='T-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext'></a>
## ExtensionContext `type`

##### Namespace

Microsoft.Internal.VisualStudio.Extensibility.Framework
...
<a name='P-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext-ServiceBroker'></a>
### ServiceBroker `property`

##### Summary

Gets the service broker associated with current context.

<a name='P-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext-ServiceProvider'></a>
...
<a name='P-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext-TraceSource'></a>
### TraceSource `property`

##### Summary

Gets the trace source associated with current context.

<a name='M-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext-CreateAndSetInitialContext'></a>
### CreateAndSetInitialContext() `method`

##### Summary

Create a new extension context scoped for the current service instance being queried.

##### Returns

an uninitialized [ServiceScope](#T-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext-ServiceScope 'Microsoft.Internal.VisualStudio.Extensibility.Framework.ExtensionContext.ServiceScope') instance.

##### Parameters

This method has no parameters.

<a name='M-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext-RestoreServiceScope-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext-ServiceScope-'></a>
### RestoreServiceScope(capturedScope) `method`

##### Summary

Restores a service scope captured earlier.

##### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| capturedScope | [Microsoft.Internal.VisualStudio.Extensibility.Framework.ExtensionContext.ServiceScope](#T-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext-ServiceScope 'Microsoft.Internal.VisualStudio.Extensibility.Framework.ExtensionContext.ServiceScope') | A [ServiceScope](#T-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext-ServiceScope 'Microsoft.Internal.VisualStudio.Extensibility.Framework.ExtensionContext.ServiceScope') instance. |

<a name='M-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext-VerifyIsPresent``1-``0-'></a>
### VerifyIsPresent\`\`1(value) `method`

##### Summary

Verifies if value is not null and throws InvalidOperationException otherwise.
...
<a name='M-Microsoft-VisualStudio-Extensibility-ExtensionCore-CreateExtensionDescriptor-Microsoft-ServiceHub-Framework-ServiceRpcDescriptor-'></a>
### CreateExtensionDescriptor(serviceDescriptor) `method`

##### Summary

Applies recommended settings to service descriptors.

##### Returns

Modified service descriptor with recommended settings.

##### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| serviceDescriptor | [Microsoft.ServiceHub.Framework.ServiceRpcDescriptor](#T-Microsoft-ServiceHub-Framework-ServiceRpcDescriptor 'Microsoft.ServiceHub.Framework.ServiceRpcDescriptor') | Original service descriptor. |
...
<a name='M-Microsoft-VisualStudio-Extensibility-ExtensionCore-GetServiceScopeForTargetObject-System-Object-'></a>
### GetServiceScopeForTargetObject(targetObject) `method`

##### Summary

Gets the service scope that was associated with a target object before.

##### Returns

null if no associated scope was found, the instance otherwise.

##### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| targetObject | [System.Object](http://msdn.microsoft.com/query/dev14.query?appId=Dev14IDEF1&l=EN-US&k=k:System.Object 'System.Object') | Target object instance to query. |
...
<a name='M-Microsoft-VisualStudio-Extensibility-ExtensionCore-ProfferBrokeredService-Microsoft-VisualStudio-Extensibility-BrokeredServiceConfiguration,Microsoft-ServiceHub-Framework-ServiceRpcDescriptor-'></a>
### ProfferBrokeredService(brokeredServiceConfiguration,descriptor) `method`
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| brokeredServiceConfiguration | [Microsoft.VisualStudio.Extensibility.BrokeredServiceConfiguration](#T-Microsoft-VisualStudio-Extensibility-BrokeredServiceConfiguration 'Microsoft.VisualStudio.Extensibility.BrokeredServiceConfiguration') | Brokered service configuration to proffer. |
| descriptor | [Microsoft.ServiceHub.Framework.ServiceRpcDescriptor](#T-Microsoft-ServiceHub-Framework-ServiceRpcDescriptor 'Microsoft.ServiceHub.Framework.ServiceRpcDescriptor') | Descriptor to utilize when initializing the service. |
...
<a name='M-Microsoft-VisualStudio-Extensibility-Helpers-ExtensionMethods-ToServiceMoniker-Microsoft-VisualStudio-Extensibility-BrokeredServiceConfiguration-'></a>
### ToServiceMoniker(brokeredServiceConfiguration) `method`

##### Summary

Converts a brokered service registration in to a [ServiceMoniker](#T-Microsoft-ServiceHub-Framework-ServiceMoniker 'Microsoft.ServiceHub.Framework.ServiceMoniker').

##### Returns

an instance of [ServiceMoniker](#T-Microsoft-ServiceHub-Framework-ServiceMoniker 'Microsoft.ServiceHub.Framework.ServiceMoniker').

##### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| brokeredServiceConfiguration | [Microsoft.VisualStudio.Extensibility.BrokeredServiceConfiguration](#T-Microsoft-VisualStudio-Extensibility-BrokeredServiceConfiguration 'Microsoft.VisualStudio.Extensibility.BrokeredServiceConfiguration') | Configuration instance to utilize. |
...
<a name='M-Microsoft-VisualStudio-Extensibility-ExtensionPart-#ctor'></a>
### #ctor() `constructor`
...
This constructors utilizes [ExtensionContext](#T-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext 'Microsoft.Internal.VisualStudio.Extensibility.Framework.ExtensionContext') to get required services.
...
<a name='T-Microsoft-VisualStudio-Extensibility-ExtensionProvidedDescriptorFactory'></a>
## ExtensionProvidedDescriptorFactory `type`
...
<a name='M-Microsoft-VisualStudio-Extensibility-ExtensionProvidedDescriptorFactory-CreateAsync-Microsoft-ServiceHub-Framework-ServiceMoniker,Microsoft-ServiceHub-Framework-ServiceActivationOptions,System-IServiceProvider,System-Type,System-Type-'></a>
### CreateAsync() `method`
...
<a name='M-Microsoft-VisualStudio-Extensibility-ExtensionProvidedDescriptorFactory-GetServiceDescriptor-Microsoft-ServiceHub-Framework-ServiceMoniker-'></a>
### GetServiceDescriptor() `method`
...
<a name='M-Microsoft-VisualStudio-Extensibility-UI-IAsyncCommand-ExecuteAsync-System-Object,Microsoft-VisualStudio-Extensibility-IClientContext,System-Threading-CancellationToken-'></a>
### ExecuteAsync(parameter,clientContext,cancellationToken) `method`
...
| clientContext | [Microsoft.VisualStudio.Extensibility.IClientContext](#T-Microsoft-VisualStudio-Extensibility-IClientContext 'Microsoft.VisualStudio.Extensibility.IClientContext') | Client context at the time of command invocation. |
...
<a name='P-Microsoft-VisualStudio-Extensibility-Framework-MessageContextJsonRpc-ServiceScope'></a>
### ServiceScope `property`

##### Summary

Gets or sets the service scope associated with this instance.
...
<a name='M-Microsoft-VisualStudio-Extensibility-Framework-MultiTargetingRpcConnection-#ctor-Microsoft-ServiceHub-Framework-ServiceJsonRpcDescriptor-JsonRpcConnection,Microsoft-VisualStudio-Extensibility-ExtensionCore-'></a>
### #ctor(jsonRpcConnection,extension) `constructor`
...
| extension | [Microsoft.VisualStudio.Extensibility.ExtensionCore](#T-Microsoft-VisualStudio-Extensibility-ExtensionCore 'Microsoft.VisualStudio.Extensibility.ExtensionCore') | Optional extension instance to retrieve extension context to pass to JsonRpc instances. |
...
<a name='M-Microsoft-VisualStudio-Extensibility-Framework-MultiTargetingServiceJsonRpcDescriptor-#ctor-Microsoft-ServiceHub-Framework-ServiceJsonRpcDescriptor,Microsoft-Internal-VisualStudio-Extensibility-Framework-MessageVersionContext,Microsoft-VisualStudio-Extensibility-ExtensionCore-'></a>
### #ctor(innerDescriptor,messageVersionContext,extension) `constructor`
...
| extension | [Microsoft.VisualStudio.Extensibility.ExtensionCore](#T-Microsoft-VisualStudio-Extensibility-ExtensionCore 'Microsoft.VisualStudio.Extensibility.ExtensionCore') | Optional extension instance to help with setting/restoring context. |
...
<a name='M-Microsoft-VisualStudio-Extensibility-UI-RemoteUserControl-#ctor-System-Object-'></a>
...
<a name='M-Microsoft-VisualStudio-Extensibility-UI-RemoteUserControl-#ctor-System-Object,Microsoft-VisualStudio-Extensibility-VisualStudioExtensibility,System-Threading-SynchronizationContext-'></a>
### #ctor(dataContext,extensibility,synchronizationContext) `constructor`
...
| dataContext | [System.Object](http://msdn.microsoft.com/query/dev14.query?appId=Dev14IDEF1&l=EN-US&k=k:System.Object 'System.Object') | Data context of the remote control which can be referenced from xaml through data
binding. |
| extensibility | [Microsoft.VisualStudio.Extensibility.VisualStudioExtensibility](#T-Microsoft-VisualStudio-Extensibility-VisualStudioExtensibility 'Microsoft.VisualStudio.Extensibility.VisualStudioExtensibility') | Extensibility object instance to provide context. |
| synchronizationContext | [System.Threading.SynchronizationContext](http://msdn.microsoft.com/query/dev14.query?appId=Dev14IDEF1&l=EN-US&k=k:System.Threading.SynchronizationContext 'System.Threading.SynchronizationContext') | Optional [synchronizationContext](#F-Microsoft-VisualStudio-Extensibility-UI-RemoteUserControl-synchronizationContext 'Microsoft.VisualStudio.Extensibility.UI.RemoteUserControl.synchronizationContext') that the extender can
provide to ensure that [IAsyncCommand](#T-Microsoft-VisualStudio-Extensibility-UI-IAsyncCommand 'Microsoft.VisualStudio.Extensibility.UI.IAsyncCommand') are executed and properties are read and updated from the
extension main thread. |
...
<a name='M-Microsoft-VisualStudio-Extensibility-UI-RemoteUserControl-Microsoft#VisualStudio#RpcContracts#RemoteUI#IRemoteProxiedUserControl2#InvokeAsync-Microsoft-VisualStudio-RpcContracts-RemoteUI-ObjectId,Microsoft-VisualStudio-RpcContracts-RemoteUI-MessagePackFragment,System-Collections-Generic-IReadOnlyDictionary{System-String,System-String},System-Threading-CancellationToken-'></a>
### Microsoft#VisualStudio#RpcContracts#RemoteUI#IRemoteProxiedUserControl2#InvokeAsync() `method`
...
<a name='P-Microsoft-VisualStudio-Extensibility-Framework-Resources-ServiceNotRegistered'></a>
### ServiceNotRegistered `property`

##### Summary

Looks up a localized string similar to Service {0} is not registered in the extension. For extension provided brokered services, make sure it is proffered in Extension.InitializeServices override method..
...
<a name='T-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext-ServiceScope'></a>
## ServiceScope `type`

##### Namespace

Microsoft.Internal.VisualStudio.Extensibility.Framework.ExtensionContext

##### Summary

An object representing the scope of the service.

<a name='P-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext-ServiceScope-ServiceBroker'></a>
### ServiceBroker `property`

##### Summary

Gets the service broker in scope.

<a name='P-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext-ServiceScope-ServiceProvider'></a>
### ServiceProvider `property`

##### Summary

Gets the service provider in scope.

<a name='P-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext-ServiceScope-TraceSource'></a>
### TraceSource `property`

##### Summary

Gets the trace source in scope.

<a name='M-Microsoft-Internal-VisualStudio-Extensibility-Framework-ExtensionContext-ServiceScope-InitializeScope-System-IServiceProvider,Microsoft-ServiceHub-Framework-IServiceBroker,System-Diagnostics-TraceSource-'></a>
### InitializeScope(serviceProvider,serviceBroker,traceSource) `method`

##### Summary

Initializes a scope that was created earlier.

##### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| serviceProvider | [System.IServiceProvider](http://msdn.microsoft.com/query/dev14.query?appId=Dev14IDEF1&l=EN-US&k=k:System.IServiceProvider 'System.IServiceProvider') | Service provider. |
| serviceBroker | [Microsoft.ServiceHub.Framework.IServiceBroker](#T-Microsoft-ServiceHub-Framework-IServiceBroker 'Microsoft.ServiceHub.Framework.IServiceBroker') | Service broker. |
| traceSource | [System.Diagnostics.TraceSource](http://msdn.microsoft.com/query/dev14.query?appId=Dev14IDEF1&l=EN-US&k=k:System.Diagnostics.TraceSource 'System.Diagnostics.TraceSource') | Trace source instance. |
