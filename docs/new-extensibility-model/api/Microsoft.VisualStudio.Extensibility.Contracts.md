...
- [BrokeredServiceAudience](#T-Microsoft-VisualStudio-Extensibility-BrokeredServiceAudience 'Microsoft.VisualStudio.Extensibility.BrokeredServiceAudience')
  - [Local](#F-Microsoft-VisualStudio-Extensibility-BrokeredServiceAudience-Local 'Microsoft.VisualStudio.Extensibility.BrokeredServiceAudience.Local')
...
<a name='T-Microsoft-VisualStudio-Extensibility-BrokeredServiceAudience'></a>
## BrokeredServiceAudience `type`
...
The intended audience for a brokered service registered via [BrokeredServiceConfiguration](#T-Microsoft-VisualStudio-Extensibility-BrokeredServiceConfiguration 'Microsoft.VisualStudio.Extensibility.BrokeredServiceConfiguration').

##### Remarks

This is a subset of Microsoft.VisualStudio.ServiceBroker.ServiceAudience.

<a name='F-Microsoft-VisualStudio-Extensibility-BrokeredServiceAudience-Local'></a>
### Local `constants`
...
<a name='F-Microsoft-VisualStudio-Extensibility-BrokeredServiceAudience-Public'></a>
### Public `constants`

##### Summary

The service is considered part of extensibility is available to other extensions. This flag should only be specified for services that have stable APIs.
This flag must be combined with other flags to indicate which clients are allowed to request this service.

<a name='T-Microsoft-VisualStudio-Extensibility-BrokeredServiceConfiguration'></a>
## BrokeredServiceConfiguration `type`
...
<a name='M-Microsoft-VisualStudio-Extensibility-BrokeredServiceConfiguration-#ctor-System-String,System-String,System-Type-'></a>
### #ctor(serviceName,version,implementationType) `constructor`

##### Summary

Initializes a new instance of the [BrokeredServiceConfiguration](#T-Microsoft-VisualStudio-Extensibility-BrokeredServiceConfiguration 'Microsoft.VisualStudio.Extensibility.BrokeredServiceConfiguration') class.
...
| version | [System.String](http://msdn.microsoft.com/query/dev14.query?appId=Dev14IDEF1&l=EN-US&k=k:System.String 'System.String') | Service moniker version. |
| implementationType | [System.Type](http://msdn.microsoft.com/query/dev14.query?appId=Dev14IDEF1&l=EN-US&k=k:System.Type 'System.Type') | Type that implements this service. |

<a name='P-Microsoft-VisualStudio-Extensibility-BrokeredServiceConfiguration-ImplementationType'></a>
...
<a name='P-Microsoft-VisualStudio-Extensibility-BrokeredServiceConfiguration-Name'></a>
### Name `property`
...
<a name='P-Microsoft-VisualStudio-Extensibility-BrokeredServiceConfiguration-ServiceAudience'></a>
### ServiceAudience `property`

##### Summary

Gets the service audience for the brokered service.

<a name='P-Microsoft-VisualStudio-Extensibility-BrokeredServiceConfiguration-Version'></a>
### Version `property`
...
<a name='M-Microsoft-VisualStudio-Extensibility-BrokeredServiceConfiguration-Equals-Microsoft-VisualStudio-Extensibility-BrokeredServiceConfiguration-'></a>
### Equals() `method`
...
<a name='M-Microsoft-VisualStudio-Extensibility-BrokeredServiceConfiguration-Equals-System-Object-'></a>
### Equals() `method`
...
<a name='M-Microsoft-VisualStudio-Extensibility-BrokeredServiceConfiguration-GetHashCode'></a>
### GetHashCode() `method`
...
shouldn't implement this interface directly.
...
<a name='T-Microsoft-VisualStudio-Extensibility-LanguageServer-LanguageServerProviderConfiguration'></a>
## LanguageServerProviderConfiguration `type`
...
<a name='M-Microsoft-VisualStudio-Extensibility-LanguageServer-LanguageServerProviderConfiguration-#ctor-System-String,Microsoft-VisualStudio-Extensibility-DocumentFilter[]-'></a>
### #ctor(displayName,appliesTo) `constructor`

##### Summary

Initializes a new instance of the [LanguageServerProviderConfiguration](#T-Microsoft-VisualStudio-Extensibility-LanguageServer-LanguageServerProviderConfiguration 'Microsoft.VisualStudio.Extensibility.LanguageServer.LanguageServerProviderConfiguration') class.

##### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| displayName | [System.String](http://msdn.microsoft.com/query/dev14.query?appId=Dev14IDEF1&l=EN-US&k=k:System.String 'System.String') | The display name of the language server. |
| appliesTo | [Microsoft.VisualStudio.Extensibility.DocumentFilter[]](#T-Microsoft-VisualStudio-Extensibility-DocumentFilter[] 'Microsoft.VisualStudio.Extensibility.DocumentFilter[]') | The conditions under which the LanguageServerProvider should be activated. |

<a name='P-Microsoft-VisualStudio-Extensibility-LanguageServer-LanguageServerProviderConfiguration-AppliesTo'></a>
### AppliesTo `property`
...
<a name='P-Microsoft-VisualStudio-Extensibility-LanguageServer-LanguageServerProviderConfiguration-DisplayName'></a>
### DisplayName `property`
...
<a name='M-Microsoft-VisualStudio-Extensibility-LanguageServer-LanguageServerProviderConfiguration-Equals-Microsoft-VisualStudio-Extensibility-LanguageServer-LanguageServerProviderConfiguration-'></a>
### Equals() `method`
...
<a name='M-Microsoft-VisualStudio-Extensibility-LanguageServer-LanguageServerProviderConfiguration-Equals-System-Object-'></a>
### Equals() `method`
...
<a name='M-Microsoft-VisualStudio-Extensibility-LanguageServer-LanguageServerProviderConfiguration-GetHashCode'></a>
### GetHashCode() `method`
...
<a name='P-Microsoft-VisualStudio-Extensibility-Contracts-Resources-ErrorLanguageServersOnlySupportDocumentType'></a>
### ErrorLanguageServersOnlySupportDocumentType `property`

##### Summary

Looks up a localized string similar to Language servers require specifying a document type.
