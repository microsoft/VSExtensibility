...
| Icon | CommandIconConfiguration | No | Commands can be displayed in the UI as either just an Icon, an Icon with text, or just ac icon. This property configures what that icon should be, if any. |
