...
* [Command handlers](../Extension_Guides/Command/Command.md)
* [Text view lifetime listeners](../Extension_Guides/Editor/Editor.md) for tracking text view created, closed events.
* [Text view change listeners](../Extension_Guides/Editor/Editor.md) for tracking changes to an open text view.
